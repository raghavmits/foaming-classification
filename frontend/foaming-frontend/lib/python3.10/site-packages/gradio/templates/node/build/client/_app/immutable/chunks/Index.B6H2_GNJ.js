const __vite__fileDeps=["./index.DXUvw4hM.js","./index.CTY6Xoly.js","./index.CjT7USBZ.js","./index.DfA3upGI.js","./index.CvstlSe_.js","./index.CLXppx_8.js","./frontmatter.nc_ANWdM.js","./yaml.BMKOA8H-.js","./index.CnyJsvOi.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { I as IconButton, F as Check, G as Copy$1, B as Block, S as Static } from "./2.m1a33O_T.js";
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.DXUvw4hM.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.CjT7USBZ.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.nc_ANWdM.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => __vitePreload(() => import("./index.CnyJsvOi.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.DfA3upGI.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.CvstlSe_.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.CLXppx_8.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.CLXppx_8.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(
