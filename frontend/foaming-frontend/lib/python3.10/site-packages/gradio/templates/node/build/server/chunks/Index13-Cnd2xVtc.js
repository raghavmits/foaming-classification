...
import { B as Block, S as Static, f as BlockLabel, N as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-BotjbI-q.js';
...
const lang_map = {
  python: () => import('./index28-BS-OG5PW.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-D5uTNqLs.js'),
      import('./frontmatter-BEz4IfXD.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-ByCL-Khv.js').then((m) => m.json()),
  html: () => import('./index30-DatrWupJ.js').then((m) => m.html()),
  css: () => import('./index31-CG7oJ2T2.js').then((m) => m.css()),
  javascript: () => import('./index32-0c3OJVpE.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-0c3OJVpE.js').then(
...
//# sourceMappingURL=Index13-Cnd2xVtc.js.map
